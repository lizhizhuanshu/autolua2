...
import com.autolua.autolua2.MainApp;
...
public class ResourcesUtils {
    ...
    public static int getResourceIdByName(String name, TYPE type) {
        return getResources().getIdentifier(name, type.toString(), MainApp.Companion.getPackageNameImpl());
    }
    ...
    public static Resources getResources() {
        return MainApp.Companion.getInstance().getResources();
    }
}